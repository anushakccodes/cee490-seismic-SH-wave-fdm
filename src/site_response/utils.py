...
def prepare_project_outputs(config: SimulationConfig) -> None:
    """Create output directories used by the project workflow."""
    ensure_output_directories(config)


def save_simulation_result_npz(result: SimulationResult, output_path: Path | str) -> None:
    """Save the main numerical arrays from a simulation to a compressed NPZ file."""
